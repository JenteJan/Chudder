...
import 'package:chudder/screens/settings/widgets/key_listener.dart';
...
import 'package:chudder/util/box_fit_extension.dart';
...
/// The player settings rows, split out so the settings search can build and
/// match them without the page being open.
List<Widget> buildPlayerSettingsItems(BuildContext context, WidgetRef ref) {
          ...
          SettingsListTileEnum(
            ...
            itemBuilder: (context) => [
              ItemActionButton(
                ...
                action: () =>
                    ref.read(videoPlayerSettingsProvider.notifier).state = videoSettings.copyWith(playerOptions: null),
              ),
