  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: InkWell(
        ...
        // The entry draws its own ground and ring; Material's square wash
        // under a rounded entry is not wanted on top.
        ...
        // The ring every selected thing wears - see [FocusRing] - over the
        // lighter ground a hover gives the entry.
        child: FocusRing(
          visible: hasFocus,
                            ...
                            children: [
                              ...
                              AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(8),
                                  color:
                                      Theme.of(context).colorScheme.primary.withValues(alpha: widget.selected ? 1 : 0),
                                ),
                              ),
                            ],
                          ),
