...
class BatteryOptimizationPigeon {
  /// Constructor for [BatteryOptimizationPigeon].  The [binaryMessenger] named argument is
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  BatteryOptimizationPigeon({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
