...
import 'package:chudder/models/playback/audio_prefetch_buffer.dart';
...
import 'package:chudder/src/video_player_helper.g.dart' hide PlaybackState;
...
import 'package:chudder/wrappers/players/lib_mpv.dart';
...
class MediaControlsWrapper extends BaseAudioHandler implements VideoPlayerControlsCallback {
  ...
  Future<void> setVolume(double volume) async {
    ...
    // device is what "volume" means there, not this phone's system volume.
    if (!kIsWeb && !isCasting && (Platform.isAndroid || Platform.isIOS)) {
