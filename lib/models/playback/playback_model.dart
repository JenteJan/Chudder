...
class PlaybackModelHelper {
  ...
  Future<OfflinePlaybackModel?> _createOfflinePlaybackModel(
    ...
    if (syncedItemModel == null || syncedItem == null || !await syncedItem.videoFile.exists()) {
      return null;
    }
    ...
    try {
      ...
      if (((showPlaybackOptions || firstItemIsSynced) && !isOffline) && context != null) {
        ...
        return switch (playbackType) {
          PlaybackType.directStream || PlaybackType.transcode ||
          PlaybackType.tv => await _createServerPlaybackModel(
              fullItem,
              item.streamModel,
  ...
  Future<PlaybackModel?> _createServerPlaybackModel(
    ...
    try {
      ...
      final mediaSegments =
          mergeWithChapterSegments(apiMediaSegments?.body, chapterSegments);
